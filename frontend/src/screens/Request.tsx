    ...
    return (
        ...
        <View style={styles.rowContainer}>
          <TouchableOpacity onPress={this.onPress} >
            <Image style={styles.thumb} source={{ uri:  "https://i.pinimg.com/236x/83/0f/71/830f71015b4a7383998416fe7f07c7eb--the-joker-jokers.jpg" }} />
          </TouchableOpacity>
...
class PureRequest extends React.Component<RequestProps, RequestStates> {
  ...
  async componentWillMount() {  
    axios.get(`${Config.API_SERVER}/api/connection/request/sent`, {
  ...
  render() {
    return (
      ...
      <View style={styles.buttonContainer}>
        <LeftTopButton leftButtonName={'RECEIVED'} onPress={() => {console.log('received')}} />
        <RightTopButton rightButtonName={'SENT'} onPress={() => {console.log('sent')}} />
      </View>
